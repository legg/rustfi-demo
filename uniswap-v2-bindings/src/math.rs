...
pub mod math {
    ...
    pub static MATH_BYTECODE: ethers::contract::Lazy<ethers::core::types::Bytes> =
        ethers::contract::Lazy::new(|| {
            "0x60556023600b82828239805160001a607314601657fe5b30600052607381538281f3fe73000000000000000000000000000000000000000030146080604052600080fdfea265627a7a72315820c9fec7bc07ce4f2cd870da86c66a7f80d8320ff8ef4239edfe9b0f47ddf1f71864736f6c63430005100032" . parse () . expect ("invalid bytecode")
        });

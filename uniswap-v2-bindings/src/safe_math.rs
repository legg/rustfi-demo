...
pub mod safe_math {
    ...
    pub static SAFEMATH_BYTECODE: ethers::contract::Lazy<ethers::core::types::Bytes> =
        ethers::contract::Lazy::new(|| {
            "0x60556023600b82828239805160001a607314601657fe5b30600052607381538281f3fe73000000000000000000000000000000000000000030146080604052600080fdfea265627a7a72315820fd03149ad0565ff2fbb3bf5f39a8f22aa9abf83aaf5b4de427888471964920a264736f6c63430005100032" . parse () . expect ("invalid bytecode")
        });
